package net.streets.common.enumeration;

import java.io.Serializable;
import java.util.HashMap;
import java.util.Map;

public enum StrResponseCode implements Serializable {
    ...
    StrResponseCode(int code, String message) {
        this.code = code;
        this.message = message;
    }

    StrResponseCode(StrResponseCode responseCode, String message) {
        this.code = responseCode.code;
        this.message = message;
    }

    static Map<Integer, StrResponseCode> enumMap;

    public static StrResponseCode valueOf(Long value) {
        if (enumMap == null) {
            enumMap = new HashMap<>();
            for (StrResponseCode rc : StrResponseCode.values()) {
